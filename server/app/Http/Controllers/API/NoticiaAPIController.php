...
class NoticiaAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $this->noticiaRepository->pushCriteria(new LimitOffsetCriteria($request));
    ...
    public function store(CreateNoticiaAPIRequest $request)
    {
        ...
        $noticias = $this->noticiaRepository->create($input);

        return $this->sendResponse($noticias->toArray(), 'Noticia saved successfully');
    }
